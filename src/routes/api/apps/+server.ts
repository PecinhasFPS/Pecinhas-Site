...
export async function GET() {
    const GITHUB_RAW_URL = 'https://raw.githubusercontent.com/PecinhasFPS/Pecinhas-V2/refs/heads/main/src/renderer/src/assets/apps.json';
